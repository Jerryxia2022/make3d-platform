export type TestClassificationInput = {
  readonly customerId?: number | string | null;
  readonly customerIsTestAccount?: boolean | number | string | null;
  readonly orderIsTestAccount?: boolean | number | string | null;
  readonly sourceMarkers?: readonly (string | null | undefined)[];
};

export type TestClassificationResult = {
  readonly isTest: boolean;
  readonly authoritativeTestFlag: boolean | null;
...
export function classifyTestSubject(input: TestClassificationInput): TestClassificationResult {
...
export function isRealCustomerEligibleByTestClassification(input: TestClassificationInput) {
...
function normalizeAuthoritativeFlag(value: boolean | number | string | null | undefined) {
...
function findTestSourceMarkers(values: readonly (string | null | undefined)[]) {
  const reasons: string[] = [];
